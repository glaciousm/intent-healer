...
public class IntentLineMarkerProvider implements LineMarkerProvider {
    ...
    public @Nullable LineMarkerInfo<?> getLineMarkerInfo(@NotNull PsiElement element) {
        ...
        PsiAnnotation intentAnnotation = method.getAnnotation("com.intenthealer.cucumber.annotations.Intent");
        ...
        PsiAnnotation outcomeAnnotation = method.getAnnotation("com.intenthealer.cucumber.annotations.Outcome");
